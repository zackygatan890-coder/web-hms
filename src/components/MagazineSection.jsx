...
const MagazineSection = ({ data, updateDataText, isEditMode }) => {
  return (
    <section id="magazine" className="py-32 bg-neutral-100 border-t border-neutral-200">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center mb-16 text-center">
            ...
            <h2 className="text-5xl md:text-7xl font-black mb-8 text-neutral-900 uppercase italic tracking-tighter w-full flex flex-col items-center">
